...
void default_original_rhs(const RHSFunctionInputs& v) {
    ...
    // TODO: deriv calculation? (likely not, as we're testing RHS performance
    // directly)
...
#include "generated/bssneqs_eta_const_standard_gauge.cpp"
            }
        }
    }
