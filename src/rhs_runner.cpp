...
void run_rhs_function(std::string &func_name) {
    ...
    for (unsigned int iblk = 0; iblk < bssnrhstests::numBlocks; iblk++) {
        ...
        if (verify_data) {
            ...
            deriv_y(rhs_inputs.grad2_0_1_alpha, rhs_inputs.grad_0_alpha, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_alpha, rhs_inputs.grad_0_alpha, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_alpha, rhs_inputs.grad_1_alpha, hz, sz,
                    bflag);
            ...
            deriv_y(rhs_inputs.grad2_0_1_beta0, rhs_inputs.grad_0_beta0, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_beta0, rhs_inputs.grad_0_beta0, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_beta0, rhs_inputs.grad_1_beta0, hz, sz,
                    bflag);
            ...
            deriv_y(rhs_inputs.grad2_0_1_beta1, rhs_inputs.grad_0_beta1, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_beta1, rhs_inputs.grad_0_beta1, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_beta1, rhs_inputs.grad_1_beta1, hz, sz,
                    bflag);
            ...
            deriv_y(rhs_inputs.grad2_0_1_beta2, rhs_inputs.grad_0_beta2, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_beta2, rhs_inputs.grad_0_beta2, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_beta2, rhs_inputs.grad_1_beta2, hz, sz,
                    bflag);
            ...
            deriv_y(rhs_inputs.grad2_0_1_chi, rhs_inputs.grad_0_chi, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_chi, rhs_inputs.grad_0_chi, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_chi, rhs_inputs.grad_1_chi, hz, sz,
                    bflag);
            ...
            deriv_y(rhs_inputs.grad2_0_1_gt0, rhs_inputs.grad_0_gt0, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_gt0, rhs_inputs.grad_0_gt0, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_gt0, rhs_inputs.grad_1_gt0, hz, sz,
                    bflag);
            deriv_x(rhs_inputs.grad_0_gt1, gt1, hx, sz, bflag);
            ...
            deriv_y(rhs_inputs.grad2_0_1_gt1, rhs_inputs.grad_0_gt1, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_gt1, rhs_inputs.grad_0_gt1, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_gt1, rhs_inputs.grad_1_gt1, hz, sz,
                    bflag);
            deriv_x(rhs_inputs.grad_0_gt2, gt2, hx, sz, bflag);
            ...
            deriv_y(rhs_inputs.grad2_0_1_gt2, rhs_inputs.grad_0_gt2, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_gt2, rhs_inputs.grad_0_gt2, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_gt2, rhs_inputs.grad_1_gt2, hz, sz,
                    bflag);
            ...
            deriv_y(rhs_inputs.grad2_0_1_gt3, rhs_inputs.grad_0_gt3, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_gt3, rhs_inputs.grad_0_gt3, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_gt3, rhs_inputs.grad_1_gt3, hz, sz,
                    bflag);
            ...
            deriv_y(rhs_inputs.grad2_0_1_gt4, rhs_inputs.grad_0_gt4, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_gt4, rhs_inputs.grad_0_gt4, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_gt4, rhs_inputs.grad_1_gt4, hz, sz,
                    bflag);
            ...
            deriv_y(rhs_inputs.grad2_0_1_gt5, rhs_inputs.grad_0_gt5, hy, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_0_2_gt5, rhs_inputs.grad_0_gt5, hz, sz,
                    bflag);
            deriv_z(rhs_inputs.grad2_1_2_gt5, rhs_inputs.grad_1_gt5, hz, sz,
                    bflag);
        ...
        if (verify_data) {
            ...
            if (bflag != 0) {
                bssn_bcs(a_rhs, alpha, rhs_inputs.grad_0_alpha,
                         rhs_inputs.grad_1_alpha, rhs_inputs.grad_2_alpha, pmin,
                         pmax, 1.0, 1.0, sz, bflag);
                bssn_bcs(chi_rhs, chi, rhs_inputs.grad_0_chi,
                         rhs_inputs.grad_1_chi, rhs_inputs.grad_2_chi, pmin,
                         pmax, 1.0, 1.0, sz, bflag);
                ...
                bssn_bcs(b_rhs0, beta0, rhs_inputs.grad_0_beta0,
                         rhs_inputs.grad_1_beta0, rhs_inputs.grad_2_beta0, pmin,
                         pmax, 1.0, 0.0, sz, bflag);
                bssn_bcs(b_rhs1, beta1, rhs_inputs.grad_0_beta1,
                         rhs_inputs.grad_1_beta1, rhs_inputs.grad_2_beta1, pmin,
                         pmax, 1.0, 0.0, sz, bflag);
                bssn_bcs(b_rhs2, beta2, rhs_inputs.grad_0_beta2,
                         rhs_inputs.grad_1_beta2, rhs_inputs.grad_2_beta2, pmin,
                         pmax, 1.0, 0.0, sz, bflag);

                bssn_bcs(Gt_rhs0, Gt0, rhs_inputs.grad_0_Gt0,
                         rhs_inputs.grad_1_Gt0, rhs_inputs.grad_2_Gt0, pmin,
                         pmax, 2.0, 0.0, sz, bflag);
                bssn_bcs(Gt_rhs1, Gt1, rhs_inputs.grad_0_Gt1,
                         rhs_inputs.grad_1_Gt1, rhs_inputs.grad_2_Gt1, pmin,
                         pmax, 2.0, 0.0, sz, bflag);
                bssn_bcs(Gt_rhs2, Gt2, rhs_inputs.grad_0_Gt2,
                         rhs_inputs.grad_1_Gt2, rhs_inputs.grad_2_Gt2, pmin,
                         pmax, 2.0, 0.0, sz, bflag);
                ...
                bssn_bcs(At_rhs00, At0, rhs_inputs.grad_0_At0,
                         rhs_inputs.grad_1_At0, rhs_inputs.grad_2_At0, pmin,
                         pmax, 2.0, 0.0, sz, bflag);
                bssn_bcs(At_rhs01, At1, rhs_inputs.grad_0_At1,
                         rhs_inputs.grad_1_At1, rhs_inputs.grad_2_At1, pmin,
                         pmax, 2.0, 0.0, sz, bflag);
                bssn_bcs(At_rhs02, At2, rhs_inputs.grad_0_At2,
                         rhs_inputs.grad_1_At2, rhs_inputs.grad_2_At2, pmin,
                         pmax, 2.0, 0.0, sz, bflag);
                bssn_bcs(At_rhs11, At3, rhs_inputs.grad_0_At3,
                         rhs_inputs.grad_1_At3, rhs_inputs.grad_2_At3, pmin,
                         pmax, 2.0, 0.0, sz, bflag);
                bssn_bcs(At_rhs12, At4, rhs_inputs.grad_0_At4,
                         rhs_inputs.grad_1_At4, rhs_inputs.grad_2_At4, pmin,
                         pmax, 2.0, 0.0, sz, bflag);
                bssn_bcs(At_rhs22, At5, rhs_inputs.grad_0_At5,
                         rhs_inputs.grad_1_At5, rhs_inputs.grad_2_At5, pmin,
                         pmax, 2.0, 0.0, sz, bflag);

                bssn_bcs(gt_rhs00, gt0, rhs_inputs.grad_0_gt0,
                         rhs_inputs.grad_1_gt0, rhs_inputs.grad_2_gt0, pmin,
                         pmax, 1.0, 1.0, sz, bflag);
                bssn_bcs(gt_rhs01, gt1, rhs_inputs.grad_0_gt1,
                         rhs_inputs.grad_1_gt1, rhs_inputs.grad_2_gt1, pmin,
                         pmax, 1.0, 0.0, sz, bflag);
                bssn_bcs(gt_rhs02, gt2, rhs_inputs.grad_0_gt2,
                         rhs_inputs.grad_1_gt2, rhs_inputs.grad_2_gt2, pmin,
                         pmax, 1.0, 0.0, sz, bflag);
                bssn_bcs(gt_rhs11, gt3, rhs_inputs.grad_0_gt3,
                         rhs_inputs.grad_1_gt3, rhs_inputs.grad_2_gt3, pmin,
                         pmax, 1.0, 1.0, sz, bflag);
                bssn_bcs(gt_rhs12, gt4, rhs_inputs.grad_0_gt4,
                         rhs_inputs.grad_1_gt4, rhs_inputs.grad_2_gt4, pmin,
                         pmax, 1.0, 0.0, sz, bflag);
                bssn_bcs(gt_rhs22, gt5, rhs_inputs.grad_0_gt5,
                         rhs_inputs.grad_1_gt5, rhs_inputs.grad_2_gt5, pmin,
                         pmax, 1.0, 1.0, sz, bflag);
            }
